...
public class Client {
	public static void main(String[] args) {
		...
		Developer dev1 = new Developer("Harpreet", 1, 5, 5);
        Developer dev2 = new Developer("Pawanpreet", 2, 6, 4);
        ...
        Manager man1 = new Manager("Rimal Singh", 1, 3, 5);
        Manager man2 = new Manager("Salil", 1, 4, 5);
